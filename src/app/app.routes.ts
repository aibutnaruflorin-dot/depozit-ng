...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'm-settings',          canActivate: [adminGuard], loadComponent: () => import('./features/mobile-settings/mobile-settings.component').then(m => m.MobileSettingsComponent) },
      { path: 'm-settings-catalogs', canActivate: [adminGuard], loadComponent: () => import('./features/m-settings-catalogs/m-settings-catalogs.component').then(m => m.MSettingsCatalogsComponent) },
      { path: 'm-settings-contacts', canActivate: [adminGuard], loadComponent: () => import('./features/m-settings-contacts/m-settings-contacts.component').then(m => m.MSettingsContactsComponent) },
      { path: 'm-settings-vehicles', canActivate: [adminGuard], loadComponent: () => import('./features/m-settings-vehicles/m-settings-vehicles.component').then(m => m.MSettingsVehiclesComponent) },
      { path: 'm-settings-units',    canActivate: [adminGuard], loadComponent: () => import('./features/m-settings-units/m-settings-units.component').then(m => m.MSettingsUnitsComponent) },
