...
export const DEFAULT_PERMISSIONS: AppPermission[] = [
  ...
  { id: 'ajutor_manipulant',name: 'Ajutor manipulant',isAdmin: false,
    pages: { comenzi_noi: 'none', comenzi: 'none', catalog: 'none', transport: 'read', cursele_mele: 'none', istoric: 'none', contul_meu: 'full', manual: 'full', setari: 'none' } },
  { id: 'contabilitate',    name: 'Contabilitate',    isAdmin: false,
    pages: { comenzi_noi: 'read', comenzi: 'read', catalog: 'read', transport: 'read', cursele_mele: 'none', istoric: 'full', contul_meu: 'full', manual: 'full', setari: 'none' } },
  { id: 'agent',            name: 'Agent',            isAdmin: false,
    pages: { comenzi_noi: 'full', comenzi: 'full', catalog: 'read', transport: 'read', cursele_mele: 'full', istoric: 'read', contul_meu: 'full', manual: 'full', setari: 'none' } },
